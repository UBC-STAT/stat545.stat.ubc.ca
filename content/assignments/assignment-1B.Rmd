...
This assignment first covers making a function, then using list columns (Exercise 2, covered in Week 2) to explore a data set. 
...
5. [ ] Grab the URL corresponding to your tagged release, and submit that to canvas. 
