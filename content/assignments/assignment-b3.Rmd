...
For this assignment, you'll be creating or modifying a Shiny app. You may complete Option A or Option B of this assignment (*not both*), detailed as follows:

+ **Option A:** Add three features to an already-existing BC Liquor shiny app ([Dean Attali's app](https://deanattali.com/blog/building-shiny-apps-tutorial/), or the similar one we made in lecture), and deploy it.
    - Features that we included in lecture, or that's included in Dean Attali's BC Liquor shiny app, don't count towards the total. 
...
Make a new repository in our homework Organization for this assignment. The link to do to [can be found on canvas](https://canvas.ubc.ca/courses/80817/pages/assignment-b-3-create-a-repository).
...
- There are three features in your Shiny app. Clearly state which three features you are modifying or creating in your code, with comments. Specifically, *write a sentence per feature explaining how it is useful*. (60 pts, 20 per feature)
  - **Option A:** Adding three features to the already existing BC Liquor app.
    - [ ] There's at least one new functional widget that modifies at least one output. (20 pts)
    - [ ] There's at least one change to the UI (aside from the addition of a widget). (20 pts)
