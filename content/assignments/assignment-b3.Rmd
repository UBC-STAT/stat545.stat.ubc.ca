...
Make a new repository in our homework Organization for this assignment. The link to do this [can be found on canvas](https://canvas.ubc.ca/courses/104737/assignments/1391195).

## Feature ideas 

There are countless possibilities for features, but here are just a few ideas. You can choose any 3 or more ideas from this list or do anything else! Note that many of the examples in this list refer to the BC Liquor app, but they are all still applicable to creating your own Shiny app if that is your chosen option for the assignment. Want more ideas than what's below? Check [this](https://shiny.rstudio.com/tutorial/) out.
