...
2. Implement _**5 improvements or fixes**_ (2 marks each) that you plan to address in this updated version. Describe these in the Assignment 5b README. These cannot be changes for the sake of change - they need to be obvious improvements to the app. These can be:
  - more user-friendly UI
  - more efficient server code
  - errors or bugs that needs to be fixed
  - added functionality
...
**One of the five changes must be added functionality.** The other four are up to you!
...
- [ ] (15 points) Five improvements (3 points/improvement) are described in README and implemented well. Each improvement will be graded as follows:
  - [ ] Are these good improvements?
    - They must be substantial improvements. Some suggestions:
    - Fixing bugs, errors, or unexpected errors
    - Improving user instruction, or documentation in general
    - Improve readability of output. 
      - e.g. no extraneous data (e.g. columns). 
      - e.g. plots are readable and make sense
    - Improving the UI
      - e.g. resizing, rearranging, and widget choice
    - They cannot be trivially small fixes, such as fixing small spelling errors
...
- [ ] (1 points) The overall quality of the app is good. 
  - The UI is user-friendly
  - It is clear what the app's purpose is
  - The design makes it obvious how the user needs to interact with the app
  - The server code is efficient
  
- [ ] (1 points) One point will be reserved for tidy'ness, organization, and whether the submission instructions were followed correctly
