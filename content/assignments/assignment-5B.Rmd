...
For this option, you will be updating your package to a new version. For full marks, you will need to improve your R package *significantly*. This time, we will be evaluating the quality of your R package, not just that you can create one. What kind of improvements qualify as a *significant* improvement? This is of course a bit subjective and also dependent on your individual R packages, but the quality and quantity of changes should fall under the category of a **minor** or **major** release defined on [this page](https://r-pkgs.org/release.html#release-version). Update your version number accordingly.
...
1. Create a list of _**at least 3 improvements or fixes**_ that you plan to address in this updated version. Put each distinct change (or set of changes) as a _**new github issue**_, and also briefly describe how you propose to address each issue. Some examples of possible types of issues:
...
- [ ] (1 point) Does the pull request describe how each issue was addressed?
  ...
  - The PR should have a good title
...
**README, code quality, and tidy'ness**
