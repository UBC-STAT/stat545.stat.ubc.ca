...
Click [here](https://canvas.ubc.ca/courses/156853/pages/assignment-b2-pre-bake-option) for the link to download the function. (Note that the download links on that page won't work before the morning after the Assignment B1 deadline.)
