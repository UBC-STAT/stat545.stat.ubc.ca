...
__Note__: For Assignment B-4, you will have the option to expand on your R package and develop it further (amongst other options).
...
(You tagged a release for Assignment B-1, right? If so, you can proceed to modify your repository's contents without having to worry about your Assignment B-1 submission. If you didn't, please tag a release before working on this assignment, and update your Assignment B-1 submission on canvas.)
