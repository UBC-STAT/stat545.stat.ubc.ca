...
__Deadline__: Wednesday, December 2, 2020
...
1. [ ] Indicate the code that you would run in the command line (Terminal) in order to run a part of the analysis in the background, **and** where you would run that code if you didn't have a Makefile. (2 points)
...
4. Make a Makefile in the root of your assignment repo (that is, outside of the `assignment-4b` folder). Be sure to also include the `all` and `clean` phony outputs. (4.5 points, breakdown below) 
  - [ ] Make the Makefile in the root so that you can make the assignments that are present in your repo (use a phony output per assignment). (1 point)
