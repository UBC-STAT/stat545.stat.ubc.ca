...
__Note__: For Assignment B-4, you will have the option to expand on your R package and develop it further (amongst other options). Be sure to tag a release of your work corresponding to your Assignment B-2 submission, so that you can continue working on the package if you'd like without confusing what will be graded as part of the assignment.


## Setup

No setup required -- just modify the same GitHub repository you used in Assignment B-1. (You tagged a release for Assignment B-1, right? If so, you can proceed to modify your repository's contents without having to worry about your Assignment B-1 submission. If you didn't, please tag a release before working on this assignment, and update your Assignment B-1 submission on canvas.)
