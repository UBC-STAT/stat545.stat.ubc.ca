...
For Assignment B-4 you will have the option to expand on your R package and develop it further. Once you finish the requirements for Assignment 2-B, tag a semantic versioning release (see Tidy Submission below for details) _first_. Any additional work after the first Assignment 2-B release can then count towards Assignment 5-B.


## Setup

No setup required -- just modify the same GitHub repository you used in Assignment B-1. 
...
## Exercise 1.2: Documentation of your R package (10 points)
...
- [ ] Update your README with a demonstrated use case, and build it with `devtools::build_....`

Say how to install the package. Say how to install the package corresponding to Assignment B-2: `install_github("org/repo", build_vignettes = TRUE, ref = "0.1.0")` will ensure vignettes are copied over, and 
