...
For Assignment 5-B, you will be given the opportunity to expand on your R package and develop it further. Once you finish the requirements for Assignment 2-B, tag a semantic versioning release (see Tidy Submission below for details) _first_. Any additional work after the first Assignment 2-B release will count towards Assignment 5-B.
