# config file settings determined primarily from https://github.com/UBC-STAT/stat-201-instructor/blob/master/nbgrader_config.py
# secondarily https://github.com/ttimbers/nbgrader_r_demo/blob/master/nbgrader_config.py
...
# server set up.
c.CourseDirectory.course_id = "stat-545"

# Update this list with other assignments you want
c.CourseDirectory.db_assignments = [
    dict(name="worksheet_01a"),
    dict(name="worksheet_02a"),
    dict(name="worksheet_03a"),
    dict(name="worksheet_04a"),
    dict(name="worksheet_05a"),
    dict(name="worksheet_06a"),
    dict(name="worksheet_07a"),
    dict(name="worksheet_01b"),
    dict(name="worksheet_02b"),
    dict(name="worksheet_03b"),
    dict(name="worksheet_04b"),
    dict(name="worksheet_05b"),
    dict(name="worksheet_06b"),
    dict(name="worksheet_07b")]
