...
subtitle: "https://stat545.stat.ubc.ca/"
output: 
  html_document:
    toc: true
    toc_depth: 3
...
__Duration__: `r lec0` - `r max(dates) + ddays(1)`
...
- We can't guarantee that the teaching team will be able to respond to your messages outside of typical workday hours (0900-1700 PST). So, please be mindful of a __17:00 PST cutoff on Fridays__ when asking assignment-related questions. 
...
+ **Overarching goal**: To assess students' ability to collaborate on GitHub + to identify common coding errors & apply their knowledge to solve them. This assessment would double as a group project.
