---
title: "STAT 545A Course syllabus: 2021/2022"
output: 
  # pdf_document:
  #   toc: true
  #   toc_depth: 2
...
__Duration__: `r format(lec0, "%a, %b %d")` - `r format(dates_545a[12], "%a, %b %d")`
...
here::here("content", "lecture_schedule-545a.csv") %>% 
  read_csv() %>% 
  mutate(Weekday = wday(dates_545a[-7], label = TRUE),
         Date = dates_545a_pretty_noyear[-7]) %>% 
...
| Collaborative project | 35         | Team project intended for practicing version control and collaboration, by answering some debugging problems. |
