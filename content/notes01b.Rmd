...
- Curly-Curly with dplyr
- Curly-Curly with ggplot2
- `as.formula` with `lm()`; polynomial?
- what things to test in testthat?
- documentation checklist: 
  - arguments: defaults; what the object is expecting (numeric vector? list? any vector?); 
- argument names -- maybe go through some examples and justify?
- Example of a function that does too much: my `cnqr()` function.
- Maybe fill in the assignment for a function of my choice -- maybe `max - min`.