...
By the end of this class, students will have exposure to some of the following topics:

- Make a reproducible example using the `reprex` package.
- Use of () vs. {}.
- vectors and lists
- environments and scoping
- function arguments and ellipses
- S3 objects, generic functions, and methods. 
- style guides

We'll also see a tour of some other things that were of interest to the class. 
