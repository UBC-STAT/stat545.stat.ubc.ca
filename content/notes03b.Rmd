...
For this topic, we'll be making an R package similar to the toy [powers package](https://github.com/vincenzocoia/powers). We'll be following along with ["The Whole Game" Chapter of "R packages"](https://r-pkgs.org/whole-game.html). Here are the actions digested from that chapter, with the corresponding section number for more info. 
