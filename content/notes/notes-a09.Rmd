...
Note that there is a new tidyverse-like framework of packages to help with modelling. It's called [tidymodels](https://www.tidymodels.org/). Tidymodels has come a long way since it first started, and I can see it taking the place of this lecture in the future (or at least becoming a part of the lecture). 
...
Written by Vincenzo Coia with input from Victor Yuan.