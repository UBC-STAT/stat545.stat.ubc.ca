...
## Your turn: how simple are dates? 
...
We'll show off how to use the `lubridate` package in the tidyverse to work with date variables in datasets in this [NYC Flights case study](https://raw.githubusercontent.com/UBC-STAT/stat545.stat.ubc.ca/master/content/notes/supp-a10-solution.Rmd). 
