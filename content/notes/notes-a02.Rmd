...
### Getting setup with a GitHub Personal Access Token (PAT) 

This will allow you to sync GitHub with files on your computer.

-   Quick start:

    -   [Step 1:]{.ul} Create a PAT

        -   Option 1: Go to to [\<https://github.com/settings/tokens>](https://github.com/settings/tokens){.uri} and click "Generate token". Describe the token's purpose in the Note field, e.g. "personal-macbook" or "vm-for-project-xyz". Select "repo", "user", and "workflow" for scopes.
    ...
    -   [Step 3]{.ul} (**optional but recommended**) Also save the PAT that you just made somewhere secure, like a password manager.
