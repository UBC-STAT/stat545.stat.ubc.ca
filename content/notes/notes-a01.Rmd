...
-   Lucy (instructor): [lucylgao.com](https://lucylgao.com)
...
You'll need to install some things and get set up. Most things can be found in Jenny's "happy git" book. Let's take some extra class time to struggle through this together. Need extra help? Come to office hours this week.
...
Worksheet A1 ([.ipynb](https://raw.githubusercontent.com/UBC-STAT/stat545.stat.ubc.ca/master/content/worksheets/worksheet_a01.ipynb); [viewable](https://github.com/UBC-STAT/stat545.stat.ubc.ca/blob/master/content/worksheets/worksheet_a01.ipynb)) is an \*autograded!) worksheet covering some R basics. Let's go through some of it. *It's completion is not required for the course, but future worksheets will be required*.
