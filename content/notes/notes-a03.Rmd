...
1.  Overview of collaborative project.

2.  Demonstrate making the group repository.

3.  Work period: contact your group and set up your repository. (\~10 minutes).

    1.  Find your group number, and contact your teammates.
...
5.  Make changes, and merge the branch via a pull request. (My turn)
