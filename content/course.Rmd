...
Slack channel specifically for students: <https://stat545classroom2024.slack.com/>
...
|----------|----------|-----------------------------------------------------|
| `r format(dates_545a[1] , "%a, %b %d")`    | [Installation](/notes/notes-a00)                                                       | Follow [installation instructions](/notes/notes-a00). TAs are available from 9am-10:30am for extra help if needed.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| `r format(dates_545b[5] , "%a, %b %d")` |  [Dashboards](/notes/notes-b04)                | NA                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| `r format(dates_545b[8] , "%a, %b %d")` |  [Automation](/notes/notes-b03)  (**OPTIONAL**)                                                  |                                                                                                                                                                                                                                                                                                                                                                                                              |
| `r format(dates_545b[9] , "%a, %b %d")` |  [Character data](/notes/notes-b05)                                 | Worksheet B2 ([.ipynb](https://raw.githubusercontent.com/UBC-STAT/stat545.stat.ubc.ca/master/content/worksheets/worksheet_b02.ipynb); [viewable](https://github.com/UBC-STAT/stat545.stat.ubc.ca/blob/master/content/worksheets/worksheet_b02.ipynb); [zip](https://github.com/UBC-STAT/stat545.stat.ubc.ca/raw/master/content/worksheets/worksheet_b02.ipynb.zip)) (Due Thurs Nov 28 at 17:00 PT)    |
| `r format(dates_545b[10], "%a, %b %d")` | Character data, Part 2 | Worksheet B2   |
| `r format(dates_545b[11], "%a, %b %d")` | [List columns](/notes/notes-b06)                                                                                  | Worksheet B3 ([.ipynb](https://raw.githubusercontent.com/UBC-STAT/stat545.stat.ubc.ca/master/content/worksheets/worksheet_b03.ipynb); [viewable](https://github.com/UBC-STAT/stat545.stat.ubc.ca/blob/master/content/worksheets/worksheet_b03.ipynb); [zip](https://github.com/UBC-STAT/stat545.stat.ubc.ca/raw/master/content/worksheets/worksheet_b03.ipynb.zip)) (Due Thurs Dec 5 at 17:00 PT)                                                                                                                                                                                                                                                                                                                                                                                                  |
| `r format(dates_545b[12], "%a, %b %d")` | List columns, Part 2                                                | Worksheet B3                                                                                                                                                                                                                                                                                                                                                                                                 |
| `r format(dates_545b[13], "%a, %b %d")` | [Websites/Slides](/notes/notes-b07) (**OPTIONAL**)  |        |
| `r format(dates_545b[14], "%a, %b %d")` | Review and Work Session  |   Assignment B4
...
[Assignment B1](/assignments/assignment-b1): Due **Friday, November 1, 2024 at 17:00 PT**. 

[Assignment B2](/assignments/assignment-b2): Due **Friday, November 8, 2024 at 17:00 PT**.

[Assignment B3](/assignments/assignment-b3): Due **Thursday, November 21, 2024 at 17:00 PT**. 

[Assignment B4](/assignments/assignment-b4): Due **Thursday December 5, 2024 at 17:00 PT**. 
