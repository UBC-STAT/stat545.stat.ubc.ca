...
| Week | Day      | Topic           | Duration | Lecture Notes | Checklist |
|------|----------|-----------------|----------|---------------|-----------|
| 1-B  | Tuesday  | Functions       | `r format(dates_545b[1]  - days(1), "%b %d")` - `r format(dates_545b[2]  + days(1), "%b %d")`  | [Functions](/notes01b) | [Week 1-B](/week1b) |
| 1-B  | Thursday | Functions       | `r format(dates_545b[1]  - days(1), "%b %d")` - `r format(dates_545b[2]  + days(1), "%b %d")`  |                    |  |
| 2-B  | Tuesday  | List columns    | `r format(dates_545b[3]  - days(1), "%b %d")` - `r format(dates_545b[4]  + ddays(1), "%b %d")` | [List columns](/notes02b) | [Week 2-B](/week2b) |
| 2-B  | Thursday | List columns    | `r format(dates_545b[3]  - days(1), "%b %d")` - `r format(dates_545b[4]  + ddays(1), "%b %d")` |  | [checklist](/week2b) |
| 3-B  | Tuesday  | List columns    | `r format(dates_545b[5]  - days(1), "%b %d")` - `r format(dates_545b[6]  + ddays(1), "%b %d")` |  | [Week 3-B](/week3b) |
| 3-B  | Thursday | R packages      | `r format(dates_545b[5]  - days(1), "%b %d")` - `r format(dates_545b[6]  + ddays(1), "%b %d")` | [R packages](/notes03b) |  |
| 4-B  | Tuesday  | R packages      | `r format(dates_545b[7]  - days(1), "%b %d")` - `r format(dates_545b[8]  + ddays(1), "%b %d")` |  | [Week 4-B](/week4b) |
| 4-B  | Thursday | Dashboards      | `r format(dates_545b[7]  - days(1), "%b %d")` - `r format(dates_545b[8]  + ddays(1), "%b %d")` | [Dashboards](/notes04b) |  |
| 5-B  | Tuesday  | Dashboards      | `r format(dates_545b[9]  - days(1), "%b %d")` - `r format(dates_545b[10] + ddays(1), "%b %d")` |  | [Week 5-B](/week5b) |
| 5-B  | Thursday | Automation      | `r format(dates_545b[9]  - days(1), "%b %d")` - `r format(dates_545b[10] + ddays(1), "%b %d")` | [Automation](/notes05b) |  |
| 6-B  | Tuesday  | Automation      | `r format(dates_545b[11] - days(1), "%b %d")` - `r format(dates_545b[12] + ddays(1), "%b %d")` |  | [Week 6-B](/week6b) |
| 6-B  | Thursday | Character data  | `r format(dates_545b[11] - days(1), "%b %d")` - `r format(dates_545b[12] + ddays(1), "%b %d")` | [Character data](/notes06b) |  |
| 7-B  | Tuesday  | _no new topics_ | `r format(dates_545b[13] - days(1), "%b %d")` - `r format(dates_545b[14] + ddays(1), "%b %d")` | _no notes_         | [Week 7-B](/week7b) |
| 7-B  | Thursday | _no new topics_ | `r format(dates_545b[13] - days(1), "%b %d")` - `r format(dates_545b[14] + ddays(1), "%b %d")` | _no notes_         | |
...
| Worksheet 2-B | [.ipynb](https://github.com/UBC-STAT/stat545.stat.ubc.ca/raw/master/content/worksheets/worksheet_02b.ipynb) | [view it on GitHub](https://github.com/UBC-STAT/stat545.stat.ubc.ca/blob/master/content/worksheets/worksheet_02b.ipynb) | 6 | ~~Saturday, November 7,~~ **Wed Nov 11**, 2020 at 23:59 PST |
| Worksheet 3-B |  |  |  | Saturday, December 5, 2020 at 23:59 PST |
...
| Assignment 3-B | [view](/assignments/assignment-3B) | No | Wednesday, November 25, 2020 at 23:59 PST |
| Assignment 4-B | [view](/assignments/assignment-4B) | No | Wednesday, December 02, 2020 at 23:59 PST |
| Assignment 5-B | [view](/assignments/assignment-5B) | No | Wednesday, December 09, 2020 at 23:59 PST |
...
| Week | Duration |
|------|----------|
| [Week 1-A](/week1a) | `r format(lec0 - days(1)          , "%b %d")` - `r format(dates_545a[1] + days(1), "%b %d")` |
| [Week 2-A](/week2a) | `r format(dates_545a[2]  - days(1), "%b %d")` - `r format(dates_545a[3]  + days(1), "%b %d")` |
| [Week 3-A](/week3a) | `r format(dates_545a[4]  - days(1), "%b %d")` - `r format(dates_545a[5]  + days(1), "%b %d")` |
| [Week 4-A](/week4a) | `r format(dates_545a[6]  - days(1), "%b %d")` - `r format(dates_545a[7]  + days(1), "%b %d")` |
| [Week 5-A](/week5a) | `r format(dates_545a[8]  - days(1), "%b %d")` - `r format(dates_545a[9]  + days(1), "%b %d")` |
| [Week 6-A](/week6a) | `r format(dates_545a[10] - days(1), "%b %d")` - `r format(dates_545a[11] + days(1), "%b %d")` |
| [Week 7-A](/week7a) | `r format(dates_545a[12] - days(1), "%b %d")` - `r format(dates_545a[13] + days(1), "%b %d")` |
...
| Worksheet | Download | View | # required questions |
|-----------|----------|------|----------------------|
...
| 10-A: dates, times, factors | NA | NA |
...
| **10: Factors and Dates** | 1. Understand how factors and dates work in R using forcats, lubridate and tsibble. |The [R4DS](https://r4ds.had.co.nz/dates-and-times.html) chapter on Dates and Times. The [stat545.com](https://stat545.com/factors-boss.html) chapter on Factors | 1. The [forcats](https://forcats.tidyverse.org) package page and reference guide on page. | [Worksheet 5A](https://raw.githubusercontent.com/UBC-STAT/stat545.stat.ubc.ca/master/content/worksheets/worksheet_05a.ipynb) |
| **11:Tibble Joins** | 1. Recognize how to manipulate data through a variety of tibble joins and set operations |- [Jenny's Join Cheatsheet](https://stat545.com/join-cheatsheet.html) for a quick reference to joins. | 1.Read the "two-table verbs"'s [vignette](https://cran.r-project.org/web/packages/dplyr/vignettes/two-table.html).  | [Worksheet 5A](https://raw.githubusercontent.com/UBC-STAT/stat545.stat.ubc.ca/master/content/worksheets/worksheet_05a.ipynb) |