...
|------|--------|-----------|
| `r format(dates_545a[1] , "%a, %b %d")` | [Intro to R](/notes/notes-a01)               | Worksheet A1 ([.ipynb](https://raw.githubusercontent.com/UBC-STAT/stat545.stat.ubc.ca/master/content/worksheets/worksheet_a01.ipynb); [viewable](https://github.com/UBC-STAT/stat545.stat.ubc.ca/blob/master/content/worksheets/worksheet_a01.ipynb)); also, see installation instructions in the notes.  |
| `r format(dates_545a[2] , "%a, %b %d")` | [Version Control]()          |  |
| `r format(dates_545a[3] , "%a, %b %d")` | [Authoring]()                |  |
| `r format(dates_545a[4] , "%a, %b %d")` | [Data Wrangling I]()         |  |
| `r format(dates_545a[5] , "%a, %b %d")` | [Plotting I]()               |  |
