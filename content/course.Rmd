...
| 2-B  | List columns | `r format(dates_545b[3]  - days(1), "%b %d")` - `r format(dates_545b[4]  + ddays(1), "%b %d")` | [notes](/notes02b) | checklist |
| 3-B  | R packages | `r format(dates_545b[5]  - days(1), "%b %d")` - `r format(dates_545b[6]  + ddays(1), "%b %d")` | [notes](/notes03b) | checklist |
| 4-B  | Dashboards | `r format(dates_545b[7]  - days(1), "%b %d")` - `r format(dates_545b[8]  + ddays(1), "%b %d")` | [notes](/notes04b) | checklist |
| 5-B  | Automation | `r format(dates_545b[9]  - days(1), "%b %d")` - `r format(dates_545b[10] + ddays(1), "%b %d")` | [notes](/notes05b) | checklist |
