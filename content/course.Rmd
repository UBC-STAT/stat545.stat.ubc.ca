...
| Week | Topic | Duration | Lecture Notes | Checklist |
|------|-------|----------|---------------|-----------|
| 1-B  | Functions | `r format(dates_545b[1]  - days(1), "%b %d")` - `r format(dates_545b[2]  + days(1), "%b %d")` | [notes](/notes01b) | [checklist](/week1b) |
| 2-B  | List columns | `r format(dates_545b[3]  - days(1), "%b %d")` - `r format(dates_545b[4]  + ddays(1), "%b %d")` | [notes](/notes02b) | [checklist](/week2b) |
| 3-B  | R packages | `r format(dates_545b[5]  - days(1), "%b %d")` - `r format(dates_545b[6]  + ddays(1), "%b %d")` | [notes](/notes03b) | [checklist](/week3b) |
| 4-B  | Dashboards | `r format(dates_545b[7]  - days(1), "%b %d")` - `r format(dates_545b[8]  + ddays(1), "%b %d")` | [notes](/notes04b) | [checklist](/week4b) |
| 5-B  | Automation | `r format(dates_545b[9]  - days(1), "%b %d")` - `r format(dates_545b[10] + ddays(1), "%b %d")` | [notes](/notes05b) | [checklist](/week5b) |
| 6-B  | Character data + Your Choice | `r format(dates_545b[11] - days(1), "%b %d")` - `r format(dates_545b[12] + ddays(1), "%b %d")` | [notes](/notes06b) | [checklist](/week6b) |
...
| Assignment | Instructions | Ready to launch? | Deadline |
|------------|--------------|------------------|----------|
| Assignment 1-B | [view](/assignments/assignment-1B) | Yes | ~~Saturday, November 7~~ **Wed. Nov 11**, 2020 at 23:59 PST |
| Assignment 2-B | [view](/assignments/assignment-2B) | No | Saturday, November 14, 2020 at 23:59 PST |
| Assignment 3-B | [view](/assignments/assignment-3B) | No | Saturday, November 21, 2020 at 23:59 PST |
| Assignment 4-B | [view](/assignments/assignment-4B) | No | Saturday, November 28, 2020 at 23:59 PST |
| Assignment 5-B | [view](/assignments/assignment-5B) | No | Saturday, December 5, 2020 at 23:59 PST |
