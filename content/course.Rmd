...
| **6: Data Wrangling II**               | 1. Use scoped variants of summarise() and mutate(), with across() <br /> 2. Apply your dplyr knowledge to exploratory data analysis of a dataset | | *tbd* | [Lecture Worksheet 3](https://github.com/UBC-STAT/stat545.stat.ubc.ca/blob/master/content/worksheets/worksheet_03a.ipynb) |
| **7: ggplot2 II**                      | 1.  Understand how to customize and fine-tune `ggplot2` graphics to create *effective* visualizations <br />| | *tbd* | [Lecture Worksheet 3](https://github.com/UBC-STAT/stat545.stat.ubc.ca/blob/master/content/worksheets/worksheet_03a.ipynb) |