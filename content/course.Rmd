...
| Week | Day      | Topic           | Date                                | Lecture Notes | Weekly Checklist |
|------|----------|-----------------|-------------------------------------|---------------|------------------|
| 1-B  | Tuesday  | Functions       | `r format(dates_545b[1] , "%b %d")` | [Functions](/notes01b) | [Week 1-B](/week1b) |
| 1-B  | Thursday | Functions       | `r format(dates_545b[2] , "%b %d")` |  |  |
| 2-B  | Tuesday  | List columns    | `r format(dates_545b[3] , "%b %d")` | [List columns](/notes02b) | [Week 2-B](/week2b) |
| 2-B  | Thursday | List columns    | `r format(dates_545b[4] , "%b %d")` |  |  |
| 3-B  | Tuesday  | List columns    | `r format(dates_545b[5] , "%b %d")` |  | [Week 3-B](/week3b) |
| 3-B  | Thursday | R packages      | `r format(dates_545b[6] , "%b %d")` | [R packages](/notes03b) |  |
| 4-B  | Tuesday  | R packages      | `r format(dates_545b[7] , "%b %d")` |  | [Week 4-B](/week4b) |
| 4-B  | Thursday | Dashboards      | `r format(dates_545b[8] , "%b %d")` | [Dashboards](/notes04b) |  |
| 5-B  | Tuesday  | Dashboards      | `r format(dates_545b[9] , "%b %d")` |  | [Week 5-B](/week5b) |
| 5-B  | Thursday | Automation      | `r format(dates_545b[10], "%b %d")` | [Automation](/notes05b) |  |
| 6-B  | Tuesday  | Automation      | `r format(dates_545b[11], "%b %d")` |  | [Week 6-B](/week6b) |
| 6-B  | Thursday | Character data  | `r format(dates_545b[12], "%b %d")` | [Character data](/notes06b) |  |
| 7-B  |          | _no new topics_ |  | _no notes_ | [Week 7-B](/week7b) |
...
| Assignment 3-B | [view](/assignments/assignment-3B) | Yes | Wednesday, November 25, 2020 at 23:59 PST |
...
|------|-----------------------------------------|---------------|------------------|
| 1-A  | `r format(dates_545a[1] , "%a, %b %d")` | _N/A_ | [Week 1-A](/week1a) |
| 1-A  | `r format(dates_545a[1] , "%a, %b %d")` | [Intro to R](/notes01a) |  |
| 2-A  | `r format(dates_545a[2] , "%a, %b %d")` | [Version Control](/notes02a) | [Week 2-A](/week2a) |
| 2-A  | `r format(dates_545a[3] , "%a, %b %d")` | [R Markdown](/notes03a) |  |
| 3-A  | `r format(dates_545a[4] , "%a, %b %d")` | [Data Wrangling I](/notes04a) | [Week 3-A](/week3a) |
| 3-A  | `r format(dates_545a[5] , "%a, %b %d")` | [Plotting I](/notes05a) |  |
| 4-A  | `r format(dates_545a[6] , "%a, %b %d")` | [Data Wrangling II](/notes06a) | [Week 4-A](/week4a) |
| 4-A  | `r format(dates_545a[7] , "%a, %b %d")` | [Plotting II](/notes07a) |  |
| 5-A  | `r format(dates_545a[8] , "%a, %b %d")` | [Tidy Data](/notes08a) | [Week 5-A](/week5a) |
| 5-A  | `r format(dates_545a[9] , "%a, %b %d")` | [Fitting Models](/notes09a) |  |
| 6-A  | `r format(dates_545a[10], "%a, %b %d")` | [Factors and Dates](/notes10a) | [Week 6-A](/week6a) |
| 6-A  | `r format(dates_545a[11], "%a, %b %d")` | [Tibble joins](/notes11a) |  |
| 7-A  | `r format(dates_545a[12], "%a, %b %d")` | [Reading and Writing Data](/notes12a) | [Week 7-A](/week7a) |
| 7-A  | `r format(dates_545a[13], "%a, %b %d")` | [Choose your Adventure](/notes13a) |  |
