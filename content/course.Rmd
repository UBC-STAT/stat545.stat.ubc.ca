...
|------|----------|-----------------|-------------------------------------|---------------|------------------|
| 1-B  | Tuesday  | Functions       | `r format(dates_545b[1] , "%b %d")` | [Functions](/notes/notes-b01) | [Week 1-B](/guidance/week-b1) |
| 1-B  | Thursday | Functions       | `r format(dates_545b[2] , "%b %d")` |  |  |
| 2-B  | Tuesday  | List columns    | `r format(dates_545b[3] , "%b %d")` | [List columns](/notes/notes-b02) | [Week 2-B](/guidance/week-b2) |
| 2-B  | Thursday | List columns    | `r format(dates_545b[4] , "%b %d")` |  |  |
| 3-B  | Tuesday  | List columns    | `r format(dates_545b[5] , "%b %d")` |  | [Week 3-B](guidance/week-b3) |
| 3-B  | Thursday | R packages      | `r format(dates_545b[6] , "%b %d")` | [R packages](/notes/notes-b03) |  |
| 4-B  | Tuesday  | R packages      | `r format(dates_545b[7] , "%b %d")` |  | [Week 4-B](/guidance/week-b4) |
| 4-B  | Thursday | Dashboards      | `r format(dates_545b[8] , "%b %d")` | [Dashboards](/notes/notes-b04) |  |
| 5-B  | Tuesday  | Dashboards      | `r format(dates_545b[9] , "%b %d")` |  | [Week 5-B](/guidance/week-b5) |
| 5-B  | Thursday | Automation      | `r format(dates_545b[10], "%b %d")` | [Automation](/notes/notes-b05) |  |
| 6-B  | Tuesday  | Automation      | `r format(dates_545b[11], "%b %d")` |  | [Week 6-B](/guidance/week-b6) |
| 6-B  | Thursday | Character data  | `r format(dates_545b[12], "%b %d")` | [Character data](/notes/notes-b06) |  |
| 7-B  |          | _no new topics_ |  | _no notes_ | [Week 7-B](/guidance/week-b7) |
