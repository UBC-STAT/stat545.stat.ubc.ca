...
|------|--------|-----------|
| `r format(dates_545a[1] , "%a, %b %d")` | [Intro to R](/notes/notes-a01)               | Worksheet 1A: ([.ipynb](); [viewable]()); also, see installation instructions in the notes.  |
| `r format(dates_545a[2] , "%a, %b %d")` | [Version Control]()          | Worksheet 2A: ([.ipynb](); [viewable])) |
