...
+ Fitting a model object to your data, and extract some result.
...
For this question, you'll be choosing two of the three tasks below -- both tasks that you choose are worth 5 points each. 
...
Produce something relevant from your fitted model: either predictions on Y, or a single value like a regression coefficient or a p-value. 
  ...
  - Obtain your results using the `broom` package if possible. If your model is not compatible with the broom function you're needing, then you can obtain your results by some other means. 
...
# Question 3: Reading and writing data

Get set up for this question by making a folder called `output` in the top level of your project folder / repository. You'll be saving things there. 

## 3.1 (5 points)

Take a table that you made from Milestone 2, and write it as a csv file in your `output` folder. Use the `here::here()` function.
...
Write your model object from Question 2 to an R binary file (an RDS), and load it again. Be sure to save the binary file in your `output` folder.
...
Every level-1 folder (that is, the ones stored in the top level, like "Milestone1" and "output") has a `README` file, explaining in a sentence or two what is in the folder, in plain language.

## Output (2 points)

All output is recent and relevant: 

- All Rmd files have been `knit`ted to their output, and all data files saved from Question 3 above appear in the `output` folder. 
