...
When all the open seats are taken (usually 70), the course is listed as "restricted", with the remainder (usually \~30) reserved for statistics students. The restricted seats will be released before the start of term, but in the meantime, I encourage you to join the waitlist. Best of luck!
