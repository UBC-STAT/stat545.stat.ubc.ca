...
-   *"I have taken STAT 545A for 1.5 credits in the past. Can I take STAT 545B?"* YES. But STAT 545 keeps changing to keep current with the R world. It is your responsibility to level up.

-   *"Can I just take the second half, i.e. STAT 545B?"* NO, not unless you have taken STAT 545A previously.

-   *"Can I just take the second half, i.e. STAT 545B? I'll do a self-study for STAT 545A."* Unfortunately, the answer is still no. As much as we'd want to say yes to you, it just becomes too difficult for us to evaluate your level without having seen deliverables for STAT 545A.

-   *"I am an undergraduate. Can I take this course?"* PROBABLY, IF THERE'S ROOM. Contact me. [There is a form for this.](https://www.grad.ubc.ca/forms/enrolment-undergraduate-students-graduate-course)

-   *"What if I've never had a stats class?"* There are no official pre-requisites for STAT 545A but most students will have had at least one prior statistics course or comparable experience.

### Can I audit?

Do you mean officially auditing, or just sitting in?

-   *"I'm not enrolled -- can I sit in during class?"* Unfortunately not. The room is usually at capacity, and further, we've allocated TA time for the specific number of students attending the class.chan

-   *"I'd like to officially audit -- can I?"* Absolutely! Please take a look at what is required of auditors so that you have an understanding of your expectations coming into the course; then, fill out the form ([undergraduate version](http://students.ubc.ca/enrolment/courses/academic-planning/audit); [graduate version](http://www.grad.ubc.ca/current-students/managing-your-program/audit)) and send it to Lucy to get signed.

-   *"The course is full -- can I audit instead?"* You'll still have to join the waitlist -- auditing still counts as a seat in the class, so auditing is not a way around the course capacity.
...
When all the open seats are taken (usually 100), the course is listed as "restricted", with the remainder (usually \~30) reserved for statistics students. The restricted seats will be released before the start of term, but in the meantime, I encourage you to join the waitlist. Best of luck!
