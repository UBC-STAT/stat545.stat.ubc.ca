---
title: "STAT 545A Course syllabus: 2022/2023"
output: 
  # pdf_document:
  #   toc: true
  #   toc_depth: 2
...
**Duration**: `r format(lec0, "%a, %b %d")` -
`r format(dates_545a[14], "%a, %b %d")`

-   Introduction to [R](http://www.r-project.org) and the [RStudio
    IDE](http://www.rstudio.com/products/rstudio/): scripts, the
    workspace, RStudio Projects, daily workflow
...
```{r, results = "asis"}
here::here("content", "lecture_schedule-545a-2022.csv") %>% 
  read_csv() %>% 
...
| liverable | Grade     |                                              |
+===========+===========+==============================================+
| Class     | 15        | Autograded walkthroughs to guide student     |
| w         |           | learning.                                    |
| orksheets |           |                                              |
+-----------+-----------+----------------------------------------------+
| Mini data | 50        | Students write their own mini data analysis. |
| analysis  |           |                                              |
+-----------+-----------+----------------------------------------------+
| Coll      | 35        | Team project intended for practicing version |
| aborative |           | control and collaboration, by answering some |
| project   |           | debugging problems.                          |
+-----------+-----------+----------------------------------------------+
...
Official course communications will occur on the `#announcements`
channel in Slack. You can expect to receive an invitation to the Slack
workspace by email, but if you haven't received this, please let the
instructor know.
...
<http://www.vch.ca/covid-19/covid-19-vaccine>. The higher the rate of
vaccination in our community overall, the lower the chance of spreading
this virus. You are an important part of the UBC community. Please
