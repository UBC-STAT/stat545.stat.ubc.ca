...
Note:
- all .Rmd files should be knitted to a viewable format and a link to the viwable form should be provided in the README
- README file should be comprehesive and efficiently introduce any visitor to the content of the repo

**cm101**

 - cm101: complete the worksheet for [cm101](https://github.com/STAT547-UBC-2019-20/Discussions/blob/master/participation/cm101/cm101_participation.Rmd)
...
- submit cm103 [participation worksheet](https://github.com/STAT547-UBC-2019-20/Discussions/blob/master/participation/cm103/cm103_participation.Rmd)

**cm104**

- upload `first_script.R`
- upload `test_example.R`

**cm105**

- subit cloned `demo_project`
- add functional `makefile` to the project
...
-  upadeted functioning `app.R` from cm107 class with callbacks

**cm109**

-  upadeted functioning `app.R` from cm108 class with multilevel callbacks

**cm110**

- submit the following scripts:
  + `app.R` (with new layout), 
  + `dash_functions.R` 
  + `dash_components.R` 

**cm111**

- link to your functioning and deployed Dash app (from heroku account)
- Peer review issue link is OPTIONAL

**cm112**

- submit a zipfile of your foofactors package 
...
12. **Class Meeting 12 Working with factors in R**
    - Complete [cm012-exercise.Rmd](https://raw.githubusercontent.com/STAT545-UBC/Classroom/master/tutorials/cm012-exercise.Rmd) worksheet. Instructor version can be found in the quide [lesson 12](https://stat545guidebook.netlify.com/working-with-factors-in-r.html)
    - Submit ```.Rmd``` file along with knitted version of your choice (```pdf```, ```md``` or ```html``` format)
13. **Class Meeting 13 Effective Visualizations**
	- Complete [cm013-exercise.Rmd](https://raw.githubusercontent.com/STAT545-UBC/Classroom/master/cm013.Rmd) worksheet. Instructor version can be found in the quide [lesson 13](	https://stat545guidebook.netlify.com/effective-visualizations.html#plotly-demo-10-mins)
	- Submit ```.Rmd``` file along with knitted version of your choice (```pdf```, ```md``` or ```html``` format)
