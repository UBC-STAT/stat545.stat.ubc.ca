...
#### 1.3 - Below is sample code creates a ggplot with fuel efficiency on the x-axis and horsepower on the y-axis for three cylinder levels (4, 6, 8). Use the appropriate `purrr` function to vectorize this task.
...
### Task 2: Convert vectorized expressions into one that use for-loops
