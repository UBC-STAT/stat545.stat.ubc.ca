...
- Create a release on your project repo named milestone1 and submit that URL on Canvas for us to grade.
  - Here is an example of the URL we are expecting for milestone1: [https://github.com/STAT547-UBC-2019-20/demo_project/tree/initial](https://github.com/STAT547-UBC-2019-20/demo_project/tree/initial)
...
You can find it [here](https://github.com/STAT547-UBC-2019-20/demo_project).