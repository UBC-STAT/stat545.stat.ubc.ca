...
- All R Markdown files are `knit`ted to ~~an output readable on GitHub (probably `github_document` or `pdf_document`).~~ a readable output. This means linking to HTML files if you make them (see section on "Viewing and linking to HTML files").
