...
In this section, you will create 5 componens to your DashR app.
To be clear, it does not really matter the details (as long as it's appropriate) of what you put in here as we're just assessing the mechanics of including these components in a Dash app.

#### Grading for Task 2

Each component is worth a certain number of points (total /30).
...
- Add a markdown component that includes the following things:
  ...
  - Add a static image (make sure you have permission to use the image).
...
#### Task 2.5 - Add a graph component using ggplot and ggplotly
...
- Add a graph component using the ggplotly object you created.
...
### Task 3: Complete project reflection document

Complete the teamwork reflection document for project 1.
